...
public class Hero : MonoBehaviour
{
    ...
    void TempFire()
    {
        ...
        //Извлечение информации из WeaponType класса Projectile и использования для определения скорости движения игрового объекта projGO
    ...
    public void AbsorbPowerUp(GameObject go)
    {
        ...
        switch (pu.type)
        {
            ...
            default://Если оружие того же типа
